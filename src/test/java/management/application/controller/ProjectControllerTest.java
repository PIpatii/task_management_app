...
public class ProjectControllerTest {
    ...
    public void getProjectById_success() throws Exception {
        ...
        expected.setId(1L);
        expected.setName("project");
        expected.setDescription("description");
        expected.setStartDate(LocalDate.of(2026, 3, 10));
        expected.setEndDate(LocalDate.of(2026, 4, 10));
    ...
    public void updateProject_success() throws Exception{
        ...
        requestDto.setStatus(Project.Status.IN_PROGRESS.name());
